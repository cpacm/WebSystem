...
<form id="ff" method="post" action="update?acv.aid=${acv.aid}">
	<table cellpadding="6">
		<tr>
			<td>题名:</td>
			<td><input class="easyui-textbox" type="text" name="acv.title"
				data-options="required:false" style="width:605px;" value="${acv.title}"> </input></td>
		</tr>
		<tr>
			<td>年度:</td>
		...
		<tr>
			...
			<td><input class="easyui-textbox" type="text"
				name="acv.dcNumber" style="width:270px;" value="${acv.dcNumber}"> </input></td>
			<td>密级:</td>
			<td><input class="easyui-textbox" type="text" name="acv.level"
				style="width:270px;" value="${acv.level}"> </input></td>
		</tr>
		<tr>
			<td>分类号:</td>
		...
		<tr>
			...
			<td><input class="easyui-textbox" type="text" name="acv.fileNum"
				style="width:253px;" value="${acv.fileNum}"></input></td>
			<td>件号:</td>
			<td><input class="easyui-textbox" type="text" name="acv.partNum"
				style="width:270px;" value="${acv.partNum}"> </input></td>
		</tr>
		<tr>
			<td>录入日期:</td>
			<td><input class="easyui-textbox" type="text" name="acv.date1"
				style="width:262px;" value="${acv.date1}"> </input></td>
			<td>至</td>
			<td><input class="easyui-textbox" type="text" name="acv.date2"
				style="width:270px;" value="${acv.date2}"> </input></td>
		</tr>
	</table>
	<input class="easyui-linkbutton" type="submit" value="Update" />
